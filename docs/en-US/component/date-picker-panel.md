...
| disabled-hours        | To specify the array of hours that cannot be selected                                                                        | ^[Function]`(role: string, comparingDate?: Date) => number[]`                                                                                                  | —          |
| disabled-minutes      | To specify the array of minutes that cannot be selected                                                                      | ^[Function]`(hour: number, role: string, comparingDate?: Date) => number[]`                                                                                    | —          |
| disabled-seconds      | To specify the array of seconds that cannot be selected                                                                      | ^[Function]`(hour: number, minute: number, role: string, comparingDate?: Date) => number[]`                                                                    | —          |
...
| visible-change  | triggers when the date picker panel appears/disappears                | ^[Function]`(visibility: boolean) => void`                                                |
| pick            | triggers when the panel picks a value                                 | ^[Function]`(value: Date \| Date[] \| null) => void`                                      |
