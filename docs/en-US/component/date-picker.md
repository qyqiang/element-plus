...
| cycle                        | DatePicker for 'ap' page                                                                                                                | ^[number]                                                                                                                                                                                            | 0                                  |
| settDefaultDate              | DatePicker for 'ap' page                                                                                                                | ^[boolean]                                                                                                                                                                                           | —                                  |
| cycleType                    | add DatePicker type 'custom' and 'week'                                                                                                 | ^[string]                                                                                                                                                                                            | —                                  |
| isOk                         | whether DatePicker is confirm button                                                                                                    | ^[boolean]                                                                                                                                                                                           | true                               |
...
| float-label                  | floatLabel for the start date in range mode                                                                                             | ^[string]                                                                                                                                                                                            | —                                  |
| end-placeholder              | placeholder for the end date in range mode                                                                                              | ^[string]                                                                                                                                                                                            | —                                  |
| type                         | type of the picker                                                                                                                      | ^[enum]`'year' \| 'years' \|'month' \| 'months' \| 'date' \| 'dates' \| 'datetime' \| 'week' \| 'datetimerange' \| 'daterange' \| 'datestartrange' \| 'dateendrange' \| 'monthrange' \| 'yearrange'` | date                               |
| type-list                    | optional quick switch list for `date` / `month` / `year` panel types                                                                    | ^[array]`Array<{ key: 'date' \| 'month' \| 'year', label: string }>`                                                                                                                                 | []                                 |
...
| range-pick-type              | controls whether an explicitly directed range selection starts from the start or end date; omit it to retain the default range behavior | ^[enum]`'start' \| 'end'`                                                                                                                                                                            | —                                  |
