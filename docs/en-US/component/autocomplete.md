...
| ------------------------------------ | -------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------- | ------------ |
| always-show-suffix                   | suffix is show                                                                                                             | ^[boolean]                                                                                | true         |
| is-hover-suffix                      | whether the suffix area is displayed only on hover                                                                         | ^[boolean]                                                                                | false        |
| is-clear                             | whether the clear action is enabled when the input loses focus without selecting an option                                 | ^[boolean]                                                                                | true         |
