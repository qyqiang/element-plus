...
:::demo This hook receives the next value and current value, so you can show a confirmation dialog before allowing the selection.
...
| props ^(2.10.5)                 | configuration options                                                                                                                       | ^[object]                                                                                                                                                                   | —                                              |
...
| input-type                      | visual status style of select; an empty `error` select shows its error tooltip when focused                                                 | ^[enum]`'error' \| 'warning' \| 'info'`                                                                                                                                     | —                                              |
...
| option-width                    | custom dropdown width, only works when `fit-input-width` is `false`                                                                         | ^[string] / ^[number]                                                                                                                                                       | —                                              |
...
| add-item              | triggers when the selecte add new item                        | ^[Function]`(value: string) => void`                                |
