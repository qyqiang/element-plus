...
| required                         | whether the column header should receive the `required-column` class                                                                                                                                               | ^[boolean]                                                                                                                                                                  | false                             |
...
| edit-cell            | Custom editable content for ghost table cells. The slot scope includes `column`, so ghost-row inputs can reuse the header `label` as placeholder text. | ^[object]`{ row: any, column: TableColumnCtx<T>, $index: number }` |
