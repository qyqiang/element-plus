...
:::demo Use `ghost-table`, `edit-table`, and column `edit-cell` slots together with `show-add-column-trigger` and `show-add-row-trigger`. Newly inserted structure and the bottom ghost row stay editable through the same cell rendering flow.
...
| ghost-table                        | whether to enable ghost table rendering                                                                                                                                                                                                                                    | ^[boolean]                                                                                                                                                           | false                                                                                                                   |
| edit-table                         | whether to render column `editCell` slots together with the ghost row                                                                                                                                                                                                     | ^[boolean]                                                                                                                                                           | false                                                                                                                   |
...
| edit-cell            | Custom editable content for ghost table cells | ^[object]`{ row: any, column: TableColumnCtx<T>, $index: number }` |
