...
| z-index                            | same as z-index in native CSS, z-order of popover                                                                                                                                     | ^[number]                                                                                                                                                                   | —                                                                          |
| modal                              | whether a mask is displayed                                                                                                                                                           | ^[boolean]                                                                                                                                                                  | false                                                                      |
| modal-class                        | custom class names for mask                                                                                                                                                           | ^[string]                                                                                                                                                                   | —                                                                          |
| close-on-click-modal               | whether the Popover can be closed by clicking the mask                                                                                                                                | ^[boolean]                                                                                                                                                                  | true                                                                       |
...
| popper-options                     | parameters for popper.js                                                                                                                            | ^[object]                                                                                                                                                                   | `{modifiers: [{name: 'computeStyles',options: {gpuAcceleration: false}}]}` |
