<template>
  ...
  >
    ...
    <div v-if="showFooter && clearable" :class="ppNs.e('footer')">
      <el-button
        v-if="clearable"
...
const handleClear = () => {
  ...
  if (remainingMaxDate) {
    ...
    onParsedValueChanged(undefined, remainingMaxDate)
  } else {
  ...
  emit('pick', getPartialRangePayload([undefined, remainingMaxDate]).pickRange)
}
